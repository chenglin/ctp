...
# make tmp dir
	...
	${MKDIR} ${TempDir}/basic/build
	${MKDIR} ${TempDir}/basic/build/config
	${MKDIR} ${TempDir}/basic/build/rules
	${MKDIR} ${TempDir}/basic/src
	${MKDIR} ${TempDir}/basic/src/mod_demo
	${MKDIR} ${TempDir}/basic/src/mod_demo/src
...
# cpoy file
	...
	${CP} ${PathBase}/build/config/*                         ${TempDir}/basic/build/config
	${CP} ${PathBase}/build/rules/dllbuild                   ${TempDir}/basic/build/rules
	${CP} ${PathBase}/build/rules/exebuild                   ${TempDir}/basic/build/rules
	${CP} ${PathBase}/src/mod_demo/*                         ${TempDir}/basic/src/mod_demo
	${CP} ${PathBase}/src/mod_demo/src/*.h                   ${TempDir}/basic/src/mod_demo/src
	${CP} ${PathBase}/src/mod_demo/src/*.cpp                 ${TempDir}/basic/src/mod_demo/src
	${CP} ${PathBase}/confdev                                ${TempDir}/basic/configure
	${CP} ${PathBase}/version                                ${TempDir}/basic
